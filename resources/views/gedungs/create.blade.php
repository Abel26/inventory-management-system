<x-app-layout>
    <x-slot name="title">Tambah Gedung</x-slot>
    
    <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div>
                <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Tambah Gedung Baru</h2>
                <p class="mt-2 text-center text-sm text-gray-600">
                    Isi form di bawah untuk menambahkan data gedung baru.
                </p>
            </div>

            <div class="mt-8">
                <form class="space-y-6" action="{{ route('master-data.gedungs.store') }}" method="POST">
                    @csrf
