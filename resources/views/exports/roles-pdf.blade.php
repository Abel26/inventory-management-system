...
<head>
    <meta charset="UTF-8">
    <title>Data Roles & Permissions - PT. EBARA INDONESIA</title>
    <style>
        @page {
            ...
            <table class="data-table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 15%;">Jumlah Permission</th>
                        <th style="width: 35%;">Tanggal Dibuat</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <table class="summary-table">
                <tr>
                    <td style="width: 50%; vertical-align: top; padding: 10px; border: 1px solid #ddd;">
                        ...
                        Total Role: <strong>{{ $roles->count() }}</strong> role<br>
                        Total Permission: <strong>{{ $roles->sum('permissions_count') }}</strong> permission<br>
                        Role dengan Guard Web: <strong>{{ $roles->where('guard_name', 'web')->count() }}</strong> role<br>
                        Role dengan Guard API: <strong>{{ $roles->where('guard_name', 'api')->count() }}</strong> role
                    </td>
                    <td style="width: 50%; vertical-align: top; padding: 10px; border: 1px solid #ddd;">
                        <strong>Informasi Dokumen:</strong><br><br>
                        Tanggal Cetak: <strong>{{ date('d-m-Y H:i') }}</strong><br>
                        Sistem: <strong>Inventory Management System</strong><br><br>
                        <em style="font-size: 10px; color: #666;">* Dokumen ini dibuat secara otomatis oleh sistem</em>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table class="signature-table">
                <tr>
                    <td>
                        ...
                        <div class="signature-title">Staff IT</div>
                    </td>
                    <td>
                        <p>Diperiksa Oleh,</p>
                        <div class="signature-name">________________</div>
                    ...
                    <td>
                        <p>Disetujui Oleh,</p>
                        <div class="signature-name">________________</div>
                        <div class="signature-title">Manager IT</div>
                    </td>
                </tr>
            </table>
        </div>
